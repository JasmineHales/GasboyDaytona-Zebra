...
export function DevDevicePreviewFrame({
  ...
  return (
    <div
      className={`app-preview-column flex min-h-0 min-w-0 flex-1 flex-col bg-[var(--color-hertz-page)] p-0 sm:p-3 md:p-4 lg:p-6${useEm45Preview ? ' app-preview-column--framed' : ''}`}
    >
      {mobileSwitcher}
      <div
      ...
      >
        {useEm45Preview ? (
          <div className="dev-device-frame__chrome" aria-hidden>
            ...
            <span className="dev-device-frame__size">360 × 800</span>
          </div>
        ) : null}
        <div
